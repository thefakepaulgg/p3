...
bun test --verbose ./extensions/claude-connectors.test.ts ./extensions/advisor ./extensions/telegram-notify ./extensions/tutor-mode ./extensions/routing ./extensions/workflows
