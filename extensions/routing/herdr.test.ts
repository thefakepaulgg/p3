...
describe("Herdr Unix socket transport", () => {
  ...
  test("maps every routed operation to its protocol-19 request shape", () => {
    const cases: Array<[string[], string, Record<string, unknown>]> = [
      ...
      [["pane", "report-metadata", "w1:p1", "--source", "pi-routing:delegation", "--agent", "pi", "--applies-to-source", "herdr:pi", "--display-agent", "pi · 1 routed active"], "pane.report_metadata", { pane_id: "w1:p1", source: "pi-routing:delegation", agent: "pi", applies_to_source: "herdr:pi", display_agent: "pi · 1 routed active", clear_display_agent: false }],
      [["pane", "report-metadata", "w1:p1", "--source", "pi-routing:delegation", "--agent", "pi", "--applies-to-source", "herdr:pi", "--clear-display-agent"], "pane.report_metadata", { pane_id: "w1:p1", source: "pi-routing:delegation", agent: "pi", applies_to_source: "herdr:pi", clear_display_agent: true }],
